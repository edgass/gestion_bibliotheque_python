...
class Bibliotheque:
    def __init__(self,root):
        ...
        self.btnUpdate = Button(RightFrame1a,font=('arial',16,'bold'),text="Mettre à jour",bd=4,pady=1,padx=24,
        ...
        self.btnReset = Button(RightFrame1a,font=('arial',16,'bold'),text="Réinitialiser",bd=4,pady=1,padx=24,
